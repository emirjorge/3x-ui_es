...
iplimit_main() {
    ...
    echo -e "${green}\t6.${plain} Reiniciar Fail2ban"
    echo -e "${green}\t7.${plain} Desinstalar el límite de IP"
    echo -e "${green}\t0.${plain} Regresar al menú principal"
    read -p "Elige una opcion: " choice
    case "$choice" in
        0)
